...
// deriveTeleportEqualUserV2 returns whether this and that are equal.
func deriveTeleportEqualUserV2(this, that *UserV2) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			this.Kind == that.Kind &&
			this.SubKind == that.SubKind &&
...
// deriveTeleportEqualLoginStatus returns whether this and that are equal.
func deriveTeleportEqualLoginStatus(this, that LoginStatus) bool {
	return ((&this == nil && &that == nil) || (&this != nil && &that != nil && (*(&this)).Equal(*(&that))))
}

// deriveTeleportEqualCreatedBy returns whether this and that are equal.
func deriveTeleportEqualCreatedBy(this, that CreatedBy) bool {
	return ((&this == nil && &that == nil) || (&this != nil && &that != nil && (*(&this)).Equal(*(&that))))
}
...
func deriveTeleportEqual_16(this, that *UserSpecV2) bool {
	return (this == nil && that == nil) ||
		this != nil && that != nil &&
			deriveTeleportEqual_32(this.OIDCIdentities, that.OIDCIdentities) &&
			deriveTeleportEqual_32(this.SAMLIdentities, that.SAMLIdentities) &&
			deriveTeleportEqual_32(this.GithubIdentities, that.GithubIdentities) &&
			deriveTeleportEqual_21(this.Roles, that.Roles) &&
			deriveTeleportEqual_33(this.Traits, that.Traits) &&
			this.Status.Equal(that.Status) &&
			this.Expires.Equal(that.Expires) &&
			this.CreatedBy.Equal(that.CreatedBy) &&
			this.LocalAuth.Equal(that.LocalAuth) &&
			deriveTeleportEqual_21(this.TrustedDeviceIDs, that.TrustedDeviceIDs)
}
...
func deriveTeleportEqual_32(this, that []ExternalIdentity) bool {
	if this == nil || that == nil {
		return this == nil && that == nil
	}
	if len(this) != len(that) {
...
func deriveTeleportEqual_33(this, that map[string][]string) bool {
	...
	for k, v := range this {
		...
		if !(deriveTeleportEqual_21(v, thatv)) {
			return false
		}
	}
	return true
