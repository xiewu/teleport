...
func (c *ClusterClient) generateUserCerts(ctx context.Context, cachePolicy CertCachePolicy, params ReissueParams) (*KeyRing, error) {
	...
	case proto.UserCertsRequest_WindowsDesktop:
		keyRing.DesktopTLSCredentials[params.RouteToDesktop.WindowsDesktop] = TLSCredential{
			PrivateKey: newUserKeys.desktop,
			Cert:       certs.TLS,
		}
	}
...
func (c *ClusterClient) prepareUserCertsRequest(ctx context.Context, params ReissueParams, keyRing *KeyRing) (*newUserKeys, *proto.UserCertsRequest, error) {
	...
	case proto.UserCertsRequest_WindowsDesktop:
		...
		newUserKeys.desktop = tlsSubjectKey
	default:
	...
	return newUserKeys, &proto.UserCertsRequest{
		...
		RouteToWindowsDesktop:            params.RouteToDesktop,
...
func (c *ClusterClient) performSessionMFACeremony(ctx context.Context, rootClient *ClusterClient, params ReissueParams, keyRing *KeyRing) (*KeyRing, error) {
	...
	case params.RouteToDesktop.WindowsDesktop != "":
		promptOpts = append(promptOpts, mfa.WithPromptReasonSessionMFA("Windows Desktop", params.RouteToDesktop.WindowsDesktop))
	}
...
type newUserKeys struct {
	ssh, tls, app, db, kube, desktop *keys.PrivateKey
}
...
func PerformSessionMFACeremony(ctx context.Context, params PerformSessionMFACeremonyParams, promptOpts ...mfa.PromptOpt) (*KeyRing, *proto.Certs, error) {
	...
	case len(newCerts.TLS) > 0:
		...
		case proto.UserCertsRequest_WindowsDesktop:
			if keyRing.DesktopTLSCredentials == nil {
				keyRing.DesktopTLSCredentials = make(map[string]TLSCredential)
			}
			keyRing.DesktopTLSCredentials[certsReq.RouteToWindowsDesktop.WindowsDesktop] = TLSCredential{
				Cert:       newCerts.TLS,
				PrivateKey: params.newUserKeys.desktop,
			}
		default:
