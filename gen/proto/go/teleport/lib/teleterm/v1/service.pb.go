...
type ConnectDesktopInitRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// This should be desktop_uri.
...
func (x *ConnectDesktopInitRequest) Reset() {
	*x = ConnectDesktopInitRequest{}
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConnectDesktopInitRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectDesktopInitRequest) ProtoMessage() {}

func (x *ConnectDesktopInitRequest) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectDesktopInitRequest.ProtoReflect.Descriptor instead.
func (*ConnectDesktopInitRequest) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{1}
}

func (x *ConnectDesktopInitRequest) GetDesktopUri() string {
	if x != nil {
		return x.DesktopUri
	}
	return ""
...
func (x *ConnectDesktopInitRequest) GetLogin() string {
	if x != nil {
		return x.Login
	}
	return ""
...
type ConnectDesktopStreamRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ConnectDesktopStreamRequest) Reset() {
	*x = ConnectDesktopStreamRequest{}
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConnectDesktopStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectDesktopStreamRequest) ProtoMessage() {}

func (x *ConnectDesktopStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectDesktopStreamRequest.ProtoReflect.Descriptor instead.
func (*ConnectDesktopStreamRequest) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{2}
}

func (x *ConnectDesktopStreamRequest) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
type ConnectDesktopRequest struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Init          *ConnectDesktopInitRequest   `protobuf:"bytes,1,opt,name=init,proto3" json:"init,omitempty"`
	Data          *ConnectDesktopStreamRequest `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ConnectDesktopRequest) Reset() {
	*x = ConnectDesktopRequest{}
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConnectDesktopRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectDesktopRequest) ProtoMessage() {}

func (x *ConnectDesktopRequest) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectDesktopRequest.ProtoReflect.Descriptor instead.
func (*ConnectDesktopRequest) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{3}
}

func (x *ConnectDesktopRequest) GetInit() *ConnectDesktopInitRequest {
	if x != nil {
		return x.Init
	}
	return nil
...
func (x *ConnectDesktopRequest) GetData() *ConnectDesktopStreamRequest {
	if x != nil {
		return x.Data
	}
	return nil
...
type ConnectDesktopResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Data          []byte                 `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ConnectDesktopResponse) Reset() {
	*x = ConnectDesktopResponse{}
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ConnectDesktopResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConnectDesktopResponse) ProtoMessage() {}

func (x *ConnectDesktopResponse) ProtoReflect() protoreflect.Message {
	mi := &file_teleport_lib_teleterm_v1_service_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConnectDesktopResponse.ProtoReflect.Descriptor instead.
func (*ConnectDesktopResponse) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{4}
}

func (x *ConnectDesktopResponse) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (*LoginPasswordlessRequest_LoginPasswordlessCredentialResponse) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{30, 2}
}
...
func (*LoginRequest_LocalParams) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{33, 0}
}
...
func (*LoginRequest_SsoParams) Descriptor() ([]byte, []int) {
	return file_teleport_lib_teleterm_v1_service_proto_rawDescGZIP(), []int{33, 1}
}
...
const file_teleport_lib_teleterm_v1_service_proto_rawDesc = "" +
	...
	"\rEmptyResponse\"R\n" +
	"\x19ConnectDesktopInitRequest\x12\x1f\n" +
	"\vdesktop_uri\x18\x01 \x01(\tR\n" +
	"desktopUri\x12\x14\n" +
	"\x05login\x18\x02 \x01(\tR\x05login\"1\n" +
	"\x1bConnectDesktopStreamRequest\x12\x12\n" +
	"\x04data\x18\x01 \x01(\fR\x04data\"\xab\x01\n" +
	"\x15ConnectDesktopRequest\x12G\n" +
	"\x04init\x18\x01 \x01(\v23.teleport.lib.teleterm.v1.ConnectDesktopInitRequestR\x04init\x12I\n" +
	"\x04data\x18\x02 \x01(\v25.teleport.lib.teleterm.v1.ConnectDesktopStreamRequestR\x04data\",\n" +
	"\x16ConnectDesktopResponse\x12\x12\n" +
	...
	"&HEADLESS_AUTHENTICATION_STATE_APPROVED\x10\x032\xd7)\n" +
	...
	"\x06GetApp\x12'.teleport.lib.teleterm.v1.GetAppRequest\x1a(.teleport.lib.teleterm.v1.GetAppResponse\x12w\n" +
	"\x0eConnectDesktop\x12/.teleport.lib.teleterm.v1.ConnectDesktopRequest\x1a0.teleport.lib.teleterm.v1.ConnectDesktopResponse(\x010\x01BTZRgithub.com/gravitational/teleport/gen/proto/go/teleport/lib/teleterm/v1;teletermv1b\x06proto3"
...
var file_teleport_lib_teleterm_v1_service_proto_goTypes = []any{
	...
	(*ConnectDesktopInitRequest)(nil),                                    // 4: teleport.lib.teleterm.v1.ConnectDesktopInitRequest
	(*ConnectDesktopStreamRequest)(nil),                                  // 5: teleport.lib.teleterm.v1.ConnectDesktopStreamRequest
	(*ConnectDesktopRequest)(nil),                                        // 6: teleport.lib.teleterm.v1.ConnectDesktopRequest
	(*ConnectDesktopResponse)(nil),                                       // 7: teleport.lib.teleterm.v1.ConnectDesktopResponse
	(*RemoveClusterRequest)(nil),                                         // 8: teleport.lib.teleterm.v1.RemoveClusterRequest
	(*GetClusterRequest)(nil),                                            // 9: teleport.lib.teleterm.v1.GetClusterRequest
	(*LogoutRequest)(nil),                                                // 10: teleport.lib.teleterm.v1.LogoutRequest
	(*StartHeadlessWatcherRequest)(nil),                                  // 11: teleport.lib.teleterm.v1.StartHeadlessWatcherRequest
	(*StartHeadlessWatcherResponse)(nil),                                 // 12: teleport.lib.teleterm.v1.StartHeadlessWatcherResponse
	(*GetAccessRequestRequest)(nil),                                      // 13: teleport.lib.teleterm.v1.GetAccessRequestRequest
	(*GetAccessRequestsRequest)(nil),                                     // 14: teleport.lib.teleterm.v1.GetAccessRequestsRequest
	(*GetAccessRequestResponse)(nil),                                     // 15: teleport.lib.teleterm.v1.GetAccessRequestResponse
	(*GetAccessRequestsResponse)(nil),                                    // 16: teleport.lib.teleterm.v1.GetAccessRequestsResponse
	(*DeleteAccessRequestRequest)(nil),                                   // 17: teleport.lib.teleterm.v1.DeleteAccessRequestRequest
	(*CreateAccessRequestRequest)(nil),                                   // 18: teleport.lib.teleterm.v1.CreateAccessRequestRequest
	(*CreateAccessRequestResponse)(nil),                                  // 19: teleport.lib.teleterm.v1.CreateAccessRequestResponse
	(*AssumeRoleRequest)(nil),                                            // 20: teleport.lib.teleterm.v1.AssumeRoleRequest
	(*GetRequestableRolesRequest)(nil),                                   // 21: teleport.lib.teleterm.v1.GetRequestableRolesRequest
	(*GetRequestableRolesResponse)(nil),                                  // 22: teleport.lib.teleterm.v1.GetRequestableRolesResponse
	(*ReviewAccessRequestRequest)(nil),                                   // 23: teleport.lib.teleterm.v1.ReviewAccessRequestRequest
	(*ReviewAccessRequestResponse)(nil),                                  // 24: teleport.lib.teleterm.v1.ReviewAccessRequestResponse
	(*PromoteAccessRequestRequest)(nil),                                  // 25: teleport.lib.teleterm.v1.PromoteAccessRequestRequest
	(*PromoteAccessRequestResponse)(nil),                                 // 26: teleport.lib.teleterm.v1.PromoteAccessRequestResponse
	(*GetSuggestedAccessListsRequest)(nil),                               // 27: teleport.lib.teleterm.v1.GetSuggestedAccessListsRequest
	(*GetSuggestedAccessListsResponse)(nil),                              // 28: teleport.lib.teleterm.v1.GetSuggestedAccessListsResponse
	(*ListKubernetesResourcesRequest)(nil),                               // 29: teleport.lib.teleterm.v1.ListKubernetesResourcesRequest
	(*ListKubernetesResourcesResponse)(nil),                              // 30: teleport.lib.teleterm.v1.ListKubernetesResourcesResponse
	(*CredentialInfo)(nil),                                               // 31: teleport.lib.teleterm.v1.CredentialInfo
	(*LoginPasswordlessResponse)(nil),                                    // 32: teleport.lib.teleterm.v1.LoginPasswordlessResponse
	(*LoginPasswordlessRequest)(nil),                                     // 33: teleport.lib.teleterm.v1.LoginPasswordlessRequest
	(*FileTransferRequest)(nil),                                          // 34: teleport.lib.teleterm.v1.FileTransferRequest
	(*FileTransferProgress)(nil),                                         // 35: teleport.lib.teleterm.v1.FileTransferProgress
	(*LoginRequest)(nil),                                                 // 36: teleport.lib.teleterm.v1.LoginRequest
	(*AddClusterRequest)(nil),                                            // 37: teleport.lib.teleterm.v1.AddClusterRequest
	(*ListClustersRequest)(nil),                                          // 38: teleport.lib.teleterm.v1.ListClustersRequest
	(*ListClustersResponse)(nil),                                         // 39: teleport.lib.teleterm.v1.ListClustersResponse
	(*ListLeafClustersRequest)(nil),                                      // 40: teleport.lib.teleterm.v1.ListLeafClustersRequest
	(*ListDatabaseUsersRequest)(nil),                                     // 41: teleport.lib.teleterm.v1.ListDatabaseUsersRequest
	(*ListDatabaseUsersResponse)(nil),                                    // 42: teleport.lib.teleterm.v1.ListDatabaseUsersResponse
	...
	(*GetServersRequest)(nil),                                            // 49: teleport.lib.teleterm.v1.GetServersRequest
	(*GetServersResponse)(nil),                                           // 50: teleport.lib.teleterm.v1.GetServersResponse
...
var file_teleport_lib_teleterm_v1_service_proto_depIdxs = []int32{
	4,   // 0: teleport.lib.teleterm.v1.ConnectDesktopRequest.init:type_name -> teleport.lib.teleterm.v1.ConnectDesktopInitRequest
	5,   // 1: teleport.lib.teleterm.v1.ConnectDesktopRequest.data:type_name -> teleport.lib.teleterm.v1.ConnectDesktopStreamRequest
	84,  // 2: teleport.lib.teleterm.v1.GetAccessRequestResponse.request:type_name -> teleport.lib.teleterm.v1.AccessRequest
	84,  // 3: teleport.lib.teleterm.v1.GetAccessRequestsResponse.requests:type_name -> teleport.lib.teleterm.v1.AccessRequest
	85,  // 4: teleport.lib.teleterm.v1.CreateAccessRequestRequest.resource_ids:type_name -> teleport.lib.teleterm.v1.ResourceID
	86,  // 5: teleport.lib.teleterm.v1.CreateAccessRequestRequest.assume_start_time:type_name -> google.protobuf.Timestamp
	86,  // 6: teleport.lib.teleterm.v1.CreateAccessRequestRequest.max_duration:type_name -> google.protobuf.Timestamp
	86,  // 7: teleport.lib.teleterm.v1.CreateAccessRequestRequest.request_ttl:type_name -> google.protobuf.Timestamp
	84,  // 8: teleport.lib.teleterm.v1.CreateAccessRequestResponse.request:type_name -> teleport.lib.teleterm.v1.AccessRequest
	85,  // 9: teleport.lib.teleterm.v1.GetRequestableRolesRequest.resource_ids:type_name -> teleport.lib.teleterm.v1.ResourceID
	86,  // 10: teleport.lib.teleterm.v1.ReviewAccessRequestRequest.assume_start_time:type_name -> google.protobuf.Timestamp
	84,  // 11: teleport.lib.teleterm.v1.ReviewAccessRequestResponse.request:type_name -> teleport.lib.teleterm.v1.AccessRequest
	84,  // 12: teleport.lib.teleterm.v1.PromoteAccessRequestResponse.request:type_name -> teleport.lib.teleterm.v1.AccessRequest
	87,  // 13: teleport.lib.teleterm.v1.GetSuggestedAccessListsResponse.access_lists:type_name -> teleport.accesslist.v1.AccessList
	88,  // 14: teleport.lib.teleterm.v1.ListKubernetesResourcesResponse.resources:type_name -> teleport.lib.teleterm.v1.KubeResource
	0,   // 15: teleport.lib.teleterm.v1.LoginPasswordlessResponse.prompt:type_name -> teleport.lib.teleterm.v1.PasswordlessPrompt
	31,  // 16: teleport.lib.teleterm.v1.LoginPasswordlessResponse.credentials:type_name -> teleport.lib.teleterm.v1.CredentialInfo
	79,  // 17: teleport.lib.teleterm.v1.LoginPasswordlessRequest.init:type_name -> teleport.lib.teleterm.v1.LoginPasswordlessRequest.LoginPasswordlessRequestInit
	80,  // 18: teleport.lib.teleterm.v1.LoginPasswordlessRequest.pin:type_name -> teleport.lib.teleterm.v1.LoginPasswordlessRequest.LoginPasswordlessPINResponse
	81,  // 19: teleport.lib.teleterm.v1.LoginPasswordlessRequest.credential:type_name -> teleport.lib.teleterm.v1.LoginPasswordlessRequest.LoginPasswordlessCredentialResponse
	1,   // 20: teleport.lib.teleterm.v1.FileTransferRequest.direction:type_name -> teleport.lib.teleterm.v1.FileTransferDirection
	82,  // 21: teleport.lib.teleterm.v1.LoginRequest.local:type_name -> teleport.lib.teleterm.v1.LoginRequest.LocalParams
	83,  // 22: teleport.lib.teleterm.v1.LoginRequest.sso:type_name -> teleport.lib.teleterm.v1.LoginRequest.SsoParams
	89,  // 23: teleport.lib.teleterm.v1.ListClustersResponse.clusters:type_name -> teleport.lib.teleterm.v1.Cluster
	...
	67,  // 28: teleport.lib.teleterm.v1.ListUnifiedResourcesRequest.sort_by:type_name -> teleport.lib.teleterm.v1.SortBy
	69,  // 29: teleport.lib.teleterm.v1.ListUnifiedResourcesResponse.resources:type_name -> teleport.lib.teleterm.v1.PaginatedResource
	...
	52,  // 43: teleport.lib.teleterm.v1.TerminalService.UpdateTshdEventsServerAddress:input_type -> teleport.lib.teleterm.v1.UpdateTshdEventsServerAddressRequest
	38,  // 44: teleport.lib.teleterm.v1.TerminalService.ListRootClusters:input_type -> teleport.lib.teleterm.v1.ListClustersRequest
	40,  // 45: teleport.lib.teleterm.v1.TerminalService.ListLeafClusters:input_type -> teleport.lib.teleterm.v1.ListLeafClustersRequest
	11,  // 46: teleport.lib.teleterm.v1.TerminalService.StartHeadlessWatcher:input_type -> teleport.lib.teleterm.v1.StartHeadlessWatcherRequest
	41,  // 47: teleport.lib.teleterm.v1.TerminalService.ListDatabaseUsers:input_type -> teleport.lib.teleterm.v1.ListDatabaseUsersRequest
	49,  // 48: teleport.lib.teleterm.v1.TerminalService.GetServers:input_type -> teleport.lib.teleterm.v1.GetServersRequest
	14,  // 49: teleport.lib.teleterm.v1.TerminalService.GetAccessRequests:input_type -> teleport.lib.teleterm.v1.GetAccessRequestsRequest
	13,  // 50: teleport.lib.teleterm.v1.TerminalService.GetAccessRequest:input_type -> teleport.lib.teleterm.v1.GetAccessRequestRequest
	17,  // 51: teleport.lib.teleterm.v1.TerminalService.DeleteAccessRequest:input_type -> teleport.lib.teleterm.v1.DeleteAccessRequestRequest
	18,  // 52: teleport.lib.teleterm.v1.TerminalService.CreateAccessRequest:input_type -> teleport.lib.teleterm.v1.CreateAccessRequestRequest
	23,  // 53: teleport.lib.teleterm.v1.TerminalService.ReviewAccessRequest:input_type -> teleport.lib.teleterm.v1.ReviewAccessRequestRequest
	21,  // 54: teleport.lib.teleterm.v1.TerminalService.GetRequestableRoles:input_type -> teleport.lib.teleterm.v1.GetRequestableRolesRequest
	20,  // 55: teleport.lib.teleterm.v1.TerminalService.AssumeRole:input_type -> teleport.lib.teleterm.v1.AssumeRoleRequest
	25,  // 56: teleport.lib.teleterm.v1.TerminalService.PromoteAccessRequest:input_type -> teleport.lib.teleterm.v1.PromoteAccessRequestRequest
	27,  // 57: teleport.lib.teleterm.v1.TerminalService.GetSuggestedAccessLists:input_type -> teleport.lib.teleterm.v1.GetSuggestedAccessListsRequest
	29,  // 58: teleport.lib.teleterm.v1.TerminalService.ListKubernetesResources:input_type -> teleport.lib.teleterm.v1.ListKubernetesResourcesRequest
	37,  // 59: teleport.lib.teleterm.v1.TerminalService.AddCluster:input_type -> teleport.lib.teleterm.v1.AddClusterRequest
	8,   // 60: teleport.lib.teleterm.v1.TerminalService.RemoveCluster:input_type -> teleport.lib.teleterm.v1.RemoveClusterRequest
	44,  // 61: teleport.lib.teleterm.v1.TerminalService.ListGateways:input_type -> teleport.lib.teleterm.v1.ListGatewaysRequest
	43,  // 62: teleport.lib.teleterm.v1.TerminalService.CreateGateway:input_type -> teleport.lib.teleterm.v1.CreateGatewayRequest
	46,  // 63: teleport.lib.teleterm.v1.TerminalService.RemoveGateway:input_type -> teleport.lib.teleterm.v1.RemoveGatewayRequest
	47,  // 64: teleport.lib.teleterm.v1.TerminalService.SetGatewayTargetSubresourceName:input_type -> teleport.lib.teleterm.v1.SetGatewayTargetSubresourceNameRequest
	48,  // 65: teleport.lib.teleterm.v1.TerminalService.SetGatewayLocalPort:input_type -> teleport.lib.teleterm.v1.SetGatewayLocalPortRequest
	51,  // 66: teleport.lib.teleterm.v1.TerminalService.GetAuthSettings:input_type -> teleport.lib.teleterm.v1.GetAuthSettingsRequest
	9,   // 67: teleport.lib.teleterm.v1.TerminalService.GetCluster:input_type -> teleport.lib.teleterm.v1.GetClusterRequest
	36,  // 68: teleport.lib.teleterm.v1.TerminalService.Login:input_type -> teleport.lib.teleterm.v1.LoginRequest
	33,  // 69: teleport.lib.teleterm.v1.TerminalService.LoginPasswordless:input_type -> teleport.lib.teleterm.v1.LoginPasswordlessRequest
	10,  // 70: teleport.lib.teleterm.v1.TerminalService.Logout:input_type -> teleport.lib.teleterm.v1.LogoutRequest
	34,  // 71: teleport.lib.teleterm.v1.TerminalService.TransferFile:input_type -> teleport.lib.teleterm.v1.FileTransferRequest
	100, // 72: teleport.lib.teleterm.v1.TerminalService.ReportUsageEvent:input_type -> teleport.lib.teleterm.v1.ReportUsageEventRequest
	54,  // 73: teleport.lib.teleterm.v1.TerminalService.UpdateHeadlessAuthenticationState:input_type -> teleport.lib.teleterm.v1.UpdateHeadlessAuthenticationStateRequest
	56,  // 74: teleport.lib.teleterm.v1.TerminalService.CreateConnectMyComputerRole:input_type -> teleport.lib.teleterm.v1.CreateConnectMyComputerRoleRequest
	58,  // 75: teleport.lib.teleterm.v1.TerminalService.CreateConnectMyComputerNodeToken:input_type -> teleport.lib.teleterm.v1.CreateConnectMyComputerNodeTokenRequest
	60,  // 76: teleport.lib.teleterm.v1.TerminalService.WaitForConnectMyComputerNodeJoin:input_type -> teleport.lib.teleterm.v1.WaitForConnectMyComputerNodeJoinRequest
	62,  // 77: teleport.lib.teleterm.v1.TerminalService.DeleteConnectMyComputerNode:input_type -> teleport.lib.teleterm.v1.DeleteConnectMyComputerNodeRequest
	64,  // 78: teleport.lib.teleterm.v1.TerminalService.GetConnectMyComputerNodeName:input_type -> teleport.lib.teleterm.v1.GetConnectMyComputerNodeNameRequest
	66,  // 79: teleport.lib.teleterm.v1.TerminalService.ListUnifiedResources:input_type -> teleport.lib.teleterm.v1.ListUnifiedResourcesRequest
	70,  // 80: teleport.lib.teleterm.v1.TerminalService.GetUserPreferences:input_type -> teleport.lib.teleterm.v1.GetUserPreferencesRequest
	72,  // 81: teleport.lib.teleterm.v1.TerminalService.UpdateUserPreferences:input_type -> teleport.lib.teleterm.v1.UpdateUserPreferencesRequest
	75,  // 82: teleport.lib.teleterm.v1.TerminalService.AuthenticateWebDevice:input_type -> teleport.lib.teleterm.v1.AuthenticateWebDeviceRequest
	77,  // 83: teleport.lib.teleterm.v1.TerminalService.GetApp:input_type -> teleport.lib.teleterm.v1.GetAppRequest
	6,   // 84: teleport.lib.teleterm.v1.TerminalService.ConnectDesktop:input_type -> teleport.lib.teleterm.v1.ConnectDesktopRequest
	53,  // 85: teleport.lib.teleterm.v1.TerminalService.UpdateTshdEventsServerAddress:output_type -> teleport.lib.teleterm.v1.UpdateTshdEventsServerAddressResponse
	39,  // 86: teleport.lib.teleterm.v1.TerminalService.ListRootClusters:output_type -> teleport.lib.teleterm.v1.ListClustersResponse
	39,  // 87: teleport.lib.teleterm.v1.TerminalService.ListLeafClusters:output_type -> teleport.lib.teleterm.v1.ListClustersResponse
	12,  // 88: teleport.lib.teleterm.v1.TerminalService.StartHeadlessWatcher:output_type -> teleport.lib.teleterm.v1.StartHeadlessWatcherResponse
	42,  // 89: teleport.lib.teleterm.v1.TerminalService.ListDatabaseUsers:output_type -> teleport.lib.teleterm.v1.ListDatabaseUsersResponse
	50,  // 90: teleport.lib.teleterm.v1.TerminalService.GetServers:output_type -> teleport.lib.teleterm.v1.GetServersResponse
	16,  // 91: teleport.lib.teleterm.v1.TerminalService.GetAccessRequests:output_type -> teleport.lib.teleterm.v1.GetAccessRequestsResponse
	15,  // 92: teleport.lib.teleterm.v1.TerminalService.GetAccessRequest:output_type -> teleport.lib.teleterm.v1.GetAccessRequestResponse
	3,   // 93: teleport.lib.teleterm.v1.TerminalService.DeleteAccessRequest:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	19,  // 94: teleport.lib.teleterm.v1.TerminalService.CreateAccessRequest:output_type -> teleport.lib.teleterm.v1.CreateAccessRequestResponse
	24,  // 95: teleport.lib.teleterm.v1.TerminalService.ReviewAccessRequest:output_type -> teleport.lib.teleterm.v1.ReviewAccessRequestResponse
	22,  // 96: teleport.lib.teleterm.v1.TerminalService.GetRequestableRoles:output_type -> teleport.lib.teleterm.v1.GetRequestableRolesResponse
	3,   // 97: teleport.lib.teleterm.v1.TerminalService.AssumeRole:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	26,  // 98: teleport.lib.teleterm.v1.TerminalService.PromoteAccessRequest:output_type -> teleport.lib.teleterm.v1.PromoteAccessRequestResponse
	28,  // 99: teleport.lib.teleterm.v1.TerminalService.GetSuggestedAccessLists:output_type -> teleport.lib.teleterm.v1.GetSuggestedAccessListsResponse
	30,  // 100: teleport.lib.teleterm.v1.TerminalService.ListKubernetesResources:output_type -> teleport.lib.teleterm.v1.ListKubernetesResourcesResponse
	89,  // 101: teleport.lib.teleterm.v1.TerminalService.AddCluster:output_type -> teleport.lib.teleterm.v1.Cluster
	3,   // 102: teleport.lib.teleterm.v1.TerminalService.RemoveCluster:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	45,  // 103: teleport.lib.teleterm.v1.TerminalService.ListGateways:output_type -> teleport.lib.teleterm.v1.ListGatewaysResponse
	90,  // 104: teleport.lib.teleterm.v1.TerminalService.CreateGateway:output_type -> teleport.lib.teleterm.v1.Gateway
	3,   // 105: teleport.lib.teleterm.v1.TerminalService.RemoveGateway:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	90,  // 106: teleport.lib.teleterm.v1.TerminalService.SetGatewayTargetSubresourceName:output_type -> teleport.lib.teleterm.v1.Gateway
	90,  // 107: teleport.lib.teleterm.v1.TerminalService.SetGatewayLocalPort:output_type -> teleport.lib.teleterm.v1.Gateway
	101, // 108: teleport.lib.teleterm.v1.TerminalService.GetAuthSettings:output_type -> teleport.lib.teleterm.v1.AuthSettings
	89,  // 109: teleport.lib.teleterm.v1.TerminalService.GetCluster:output_type -> teleport.lib.teleterm.v1.Cluster
	3,   // 110: teleport.lib.teleterm.v1.TerminalService.Login:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	32,  // 111: teleport.lib.teleterm.v1.TerminalService.LoginPasswordless:output_type -> teleport.lib.teleterm.v1.LoginPasswordlessResponse
	3,   // 112: teleport.lib.teleterm.v1.TerminalService.Logout:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	35,  // 113: teleport.lib.teleterm.v1.TerminalService.TransferFile:output_type -> teleport.lib.teleterm.v1.FileTransferProgress
	3,   // 114: teleport.lib.teleterm.v1.TerminalService.ReportUsageEvent:output_type -> teleport.lib.teleterm.v1.EmptyResponse
	55,  // 115: teleport.lib.teleterm.v1.TerminalService.UpdateHeadlessAuthenticationState:output_type -> teleport.lib.teleterm.v1.UpdateHeadlessAuthenticationStateResponse
	57,  // 116: teleport.lib.teleterm.v1.TerminalService.CreateConnectMyComputerRole:output_type -> teleport.lib.teleterm.v1.CreateConnectMyComputerRoleResponse
	59,  // 117: teleport.lib.teleterm.v1.TerminalService.CreateConnectMyComputerNodeToken:output_type -> teleport.lib.teleterm.v1.CreateConnectMyComputerNodeTokenResponse
	61,  // 118: teleport.lib.teleterm.v1.TerminalService.WaitForConnectMyComputerNodeJoin:output_type -> teleport.lib.teleterm.v1.WaitForConnectMyComputerNodeJoinResponse
	63,  // 119: teleport.lib.teleterm.v1.TerminalService.DeleteConnectMyComputerNode:output_type -> teleport.lib.teleterm.v1.DeleteConnectMyComputerNodeResponse
	65,  // 120: teleport.lib.teleterm.v1.TerminalService.GetConnectMyComputerNodeName:output_type -> teleport.lib.teleterm.v1.GetConnectMyComputerNodeNameResponse
	68,  // 121: teleport.lib.teleterm.v1.TerminalService.ListUnifiedResources:output_type -> teleport.lib.teleterm.v1.ListUnifiedResourcesResponse
	71,  // 122: teleport.lib.teleterm.v1.TerminalService.GetUserPreferences:output_type -> teleport.lib.teleterm.v1.GetUserPreferencesResponse
	73,  // 123: teleport.lib.teleterm.v1.TerminalService.UpdateUserPreferences:output_type -> teleport.lib.teleterm.v1.UpdateUserPreferencesResponse
	76,  // 124: teleport.lib.teleterm.v1.TerminalService.AuthenticateWebDevice:output_type -> teleport.lib.teleterm.v1.AuthenticateWebDeviceResponse
	78,  // 125: teleport.lib.teleterm.v1.TerminalService.GetApp:output_type -> teleport.lib.teleterm.v1.GetAppResponse
	7,   // 126: teleport.lib.teleterm.v1.TerminalService.ConnectDesktop:output_type -> teleport.lib.teleterm.v1.ConnectDesktopResponse
...
func file_teleport_lib_teleterm_v1_service_proto_init() {
	...
	file_teleport_lib_teleterm_v1_service_proto_msgTypes[33].OneofWrappers = []any{
