...
/**
 * @generated from protobuf message teleport.lib.teleterm.v1.ConnectDesktopInitRequest
 */
export interface ConnectDesktopInitRequest {
    /**
...
/**
 * @generated from protobuf message teleport.lib.teleterm.v1.ConnectDesktopStreamRequest
 */
export interface ConnectDesktopStreamRequest {
    /**
 ...
 *
 * @generated from protobuf message teleport.lib.teleterm.v1.ConnectDesktopRequest
 */
export interface ConnectDesktopRequest {
    /**
     * @generated from protobuf field: teleport.lib.teleterm.v1.ConnectDesktopInitRequest init = 1;
     */
    init?: ConnectDesktopInitRequest;
    /**
     * @generated from protobuf field: teleport.lib.teleterm.v1.ConnectDesktopStreamRequest data = 2;
     */
    data?: ConnectDesktopStreamRequest;
}
/**
 * GetClusterRequest describes GetClusterRequest
 *
 * @generated from protobuf message teleport.lib.teleterm.v1.ConnectDesktopResponse
 */
export interface ConnectDesktopResponse {
    /**
     * @generated from protobuf field: bytes data = 1;
     */
    data: Uint8Array;
...
// @generated message type with reflection information, may provide speed optimized methods
class ConnectDesktopInitRequest$Type extends MessageType<ConnectDesktopInitRequest> {
    constructor() {
        super("teleport.lib.teleterm.v1.ConnectDesktopInitRequest", [
            { no: 1, name: "desktop_uri", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "login", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<ConnectDesktopInitRequest>): ConnectDesktopInitRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.desktopUri = "";
        message.login = "";
        if (value !== undefined)
            reflectionMergePartial<ConnectDesktopInitRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConnectDesktopInitRequest): ConnectDesktopInitRequest {
    ...
    internalBinaryWrite(message: ConnectDesktopInitRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.v1.ConnectDesktopInitRequest
 */
export const ConnectDesktopInitRequest = new ConnectDesktopInitRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConnectDesktopStreamRequest$Type extends MessageType<ConnectDesktopStreamRequest> {
    constructor() {
        super("teleport.lib.teleterm.v1.ConnectDesktopStreamRequest", [
            { no: 1, name: "data", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<ConnectDesktopStreamRequest>): ConnectDesktopStreamRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.data = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<ConnectDesktopStreamRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConnectDesktopStreamRequest): ConnectDesktopStreamRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ConnectDesktopStreamRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.v1.ConnectDesktopStreamRequest
 */
export const ConnectDesktopStreamRequest = new ConnectDesktopStreamRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConnectDesktopRequest$Type extends MessageType<ConnectDesktopRequest> {
    constructor() {
        super("teleport.lib.teleterm.v1.ConnectDesktopRequest", [
            { no: 1, name: "init", kind: "message", T: () => ConnectDesktopInitRequest },
            { no: 2, name: "data", kind: "message", T: () => ConnectDesktopStreamRequest }
        ]);
    }
    create(value?: PartialMessage<ConnectDesktopRequest>): ConnectDesktopRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<ConnectDesktopRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConnectDesktopRequest): ConnectDesktopRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* teleport.lib.teleterm.v1.ConnectDesktopInitRequest init */ 1:
                    message.init = ConnectDesktopInitRequest.internalBinaryRead(reader, reader.uint32(), options, message.init);
                    break;
                case /* teleport.lib.teleterm.v1.ConnectDesktopStreamRequest data */ 2:
                    message.data = ConnectDesktopStreamRequest.internalBinaryRead(reader, reader.uint32(), options, message.data);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: ConnectDesktopRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* teleport.lib.teleterm.v1.ConnectDesktopInitRequest init = 1; */
        if (message.init)
            ConnectDesktopInitRequest.internalBinaryWrite(message.init, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* teleport.lib.teleterm.v1.ConnectDesktopStreamRequest data = 2; */
        if (message.data)
            ConnectDesktopStreamRequest.internalBinaryWrite(message.data, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.v1.ConnectDesktopRequest
 */
export const ConnectDesktopRequest = new ConnectDesktopRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConnectDesktopResponse$Type extends MessageType<ConnectDesktopResponse> {
    constructor() {
        super("teleport.lib.teleterm.v1.ConnectDesktopResponse", [
            { no: 1, name: "data", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<ConnectDesktopResponse>): ConnectDesktopResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.data = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<ConnectDesktopResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConnectDesktopResponse): ConnectDesktopResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ConnectDesktopResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes data = 1; */
        if (message.data.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.data);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message teleport.lib.teleterm.v1.ConnectDesktopResponse
 */
export const ConnectDesktopResponse = new ConnectDesktopResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const TerminalService = new ServiceType("teleport.lib.teleterm.v1.TerminalService", [
    ...
    { name: "ConnectDesktop", serverStreaming: true, clientStreaming: true, options: {}, I: ConnectDesktopRequest, O: ConnectDesktopResponse }
]);
